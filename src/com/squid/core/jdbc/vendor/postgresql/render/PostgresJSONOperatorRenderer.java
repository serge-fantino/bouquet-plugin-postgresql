...
public class PostgresJSONOperatorRenderer extends BaseOperatorRenderer {

	public PostgresJSONOperatorRenderer() {
		super();
	}
	...
	public String prettyPrint(SQLSkin skin, OperatorPiece piece, OperatorDefinition opDef, String[] args) throws RenderingException {
		...
		if (opDef.getName().equals("JSON_EXTRACT_ARRAY_ELEMENT_TEXT")==false) {
			String separator = "";
			for (String arg : args) {
				txt += separator + arg;
				separator = ", ";
